...
public class PlayerMovement : MonoBehaviour
{
    ...
    Vector2 cursorOnScreen;
    Vector2 playerOnScreen;
    ...
    private void Update()
    {
        ...
        cursorOnScreen = Input.mousePosition;
        playerOnScreen = Camera.main.WorldToScreenPoint(transform.position);
    }
    ...
    void rotateBody()
    {
        if (cursorOnScreen.x > playerOnScreen.x)
        {
